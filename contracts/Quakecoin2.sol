...
contract Quakecoin2 is ERC20Detailed 
{
    ...
    string constant tokenName = "Quakecoin2";//"Quakecoin2";
    string constant tokenSymbol = "QUAKE2";//"QUAKE2"; 
    ...
    */
    ...
    function _enableStaking(address staker) private
    {
        ...
        fullUnitsStaked_total = fullUnitsStaked_total.add(fullUnitsStaked(staker));
    }
    ...
    function _disableStaking(address staker) private
    {
        ...
        fullUnitsStaked_total = fullUnitsStaked_total.sub(fullUnitsStaked(staker));
    }
